export default {
  async fetch(request, env) {
    ...
    // highlight_full_fields returns entire text with <mark> injected
    // This gives us full highlighted text in enHL.value / arHL.value
    tsUrl.searchParams.set('highlight_full_fields',   'en,ar');
    tsUrl.searchParams.set('highlight_start_tag',     '<mark>');
    tsUrl.searchParams.set('highlight_end_tag',       '</mark>');
